...
st.set_page_config(page_title="AllevaGem ERP 4.0", layout="wide", page_icon="🐄")
...
# Prezzi simulati basati su Source 63 e 66
...
# Conversione prezzo latte in libbre (1 cwt = 100 lbs)
...
def get_herd_data():
    ...
    # [span_2](start_span)Picco a 60 giorni, poi calo.[span_2](end_span)
    yields = []
    health_status = []
    ruminations = []
    ...
    for dim in dims:
        ...
        # [span_3](start_span)Simulazione eventi sanitari[span_3](end_span)
        ...
        if health_roll < 0.05:
            ...
            status = "Allarme Estro" # Picco attività
...
# [span_4](start_span)Calcolo IOFC per ogni vacca[span_4](end_span)
...
st.markdown("---")
st.caption("AllevaGem Demo - Basato sui principi di Precision Livestock Farming e Integrazione ERP.")
